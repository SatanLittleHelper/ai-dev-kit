...
| Swagger response DTOs | If `main.ts` wires up `SwaggerModule`, every controller method returns a response DTO **class**, never a bare shared interface — the CLI plugin can't introspect erased interfaces | `swagger.md` |
